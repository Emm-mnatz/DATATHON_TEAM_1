...
knitr::opts_chunk$set(
  root.dir = "C:/Users/Brandon/OneDrive - The University of Melbourne/Desktop/Health Data Science/Datathon/DATATHON_TEAM_2"
  )
```
...
# Set file paths  
if (!dir.exists('output')) dir.create(file.path(getwd(), 'output'))

# Read HIV data
hiv <- file.path(getwd(), 'input', 'HealthGymV2_CbdrhDatathon_ART4HIV.csv') %>% fread()
```

Let's have a look at our dataset. 

```{r initial look, tidy = TRUE}
# Quick look! 
glimpse(hiv)
summary(hiv)
str(hiv)
